...
```bash
git remote add encore encore://serena-ventus-landing-gx7i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/serena-ventus-landing-gx7i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/serena-ventus-landing-gx7i/settings/integrations/github)
